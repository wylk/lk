...
(function() {
    ...
    LUploader.prototype.init = function() {
        ...
        var data_name = _self.trigger.getAttribute('data-LUploader');
        var btn = document.querySelector('#' + data_name);
        ...
        _self.trigger.addEventListener('change', function() {
            ...
            files.forEach(function(file, i) {
                ...
                li.innerHTML = '<div class="LUploader-progress"><span></span><input type="hidden" name="'+data_name+'" value=""/></div>';
