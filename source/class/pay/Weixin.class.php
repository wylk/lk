...
class Weixin{
	...
	public function pay(){
		...
		// die;
		//使用统一支付接口
		if ($this->order_info['is_eb'] == 1 && option('credit.ep_balance_open') == 1) {
			$this->order_info['total'] = $this->order_info['eb_balace']>0?$this->order_info['total']-$this->order_info['eb_balace']:0;
		}
