...
<html>
  ...
  <head>
    ...
    <script type="text/javascript" src="<?php echo TPL_URL;?>x-admin/lib/layui/layui.js" charset="utf-8"></script>
...
<script type="text/javascript" src="<?php echo TPL_URL;?>/js/index_orderList.js?r=<?php echo time();?>"></script>
