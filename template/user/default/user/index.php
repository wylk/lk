      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="td-status">
                <?php if( $v["status"] ==0){ ?>
                  <button class="btn-success member_stop"   data-id="<?= $v['id'] ?>" data-status="<?= $v['status'] ?>">已启用</button>
                <?php }else{ ?>
                  <button class="btn-danger member_stop"  data-id="<?= $v['id'] ?>" data-status=status="<?= $v['status'] ?>">已禁用</button>
                <?php } ?>
            </td>
            <td class="td-manage">
