        ...
        <form class="layui-form">
          <div class="layui-form-item">
           ...
           <div class="layui-form-item">
              <label for="L_repass" class="layui-form-label">
                  <span class="x-red">*</span>认证方式
              </label>
              <div class="layui-input-inline" style="margin-top: 10px;">
                  <?php if($userAudit['type']==1){
                      echo '个人认证';
                    }elseif($userAudit['type']==2){
                      echo '企业认证';
                    }
              ?>
              </div>
          ...
          <div class="row">
            <div class="layui-col-md4">
              <label class="layui-form-label"><span class="x-red">*</span>认证时间</label>
               <div class="layui-input-inline" style="margin-top: 10px;">
